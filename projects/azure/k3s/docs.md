...
| <a name="module_k3s_first_server"></a> [k3s\_first\_server](#module\_k3s\_first\_server) | ../../../modules/infrastructure/azure/virtual-machine | n/a |
| <a name="module_k3s_servers"></a> [k3s\_servers](#module\_k3s\_servers) | ../../../modules/infrastructure/azure/virtual-machine | n/a |
| <a name="module_k3s_workers"></a> [k3s\_workers](#module\_k3s\_workers) | ../../../modules/infrastructure/azure/virtual-machine | n/a |
...
| <a name="module_os_image"></a> [os\_image](#module\_os\_image) | ../../../modules/custom-os-image/azure | n/a |
...
|------|-------------|------|---------|:--------:|
| <a name="input_ami_id"></a> [ami\_id](#input\_ami\_id) | Specifies the ID of the custom OS image used to provision all K3s cluster Azure Virtual Machines. Default is empty. | `string` | `""` | no |
